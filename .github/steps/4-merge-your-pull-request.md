...
![screenshot of green merge pull request button](https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/merge-pull-request-button.png?raw=true)
...
3. 当分支成功合并到 `main` 后，这个分支就没用了，你可以点击 Delete branch 将其删除。
   ...
   ![screenshot showing delete branch button](https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/delete-branch-button.png?raw=true)
