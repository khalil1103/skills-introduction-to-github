...
![screenshot showing an example profile readme](https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/example-profile-readme.png?raw=true)
...
2. 在仓库顶部导航栏中，点击 **< > Code** 选项。
   ...
   ![screenshot highlighting the code tab](https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/code-tab-highlight.png?raw=true)

3. 点击 **main** 分支的下拉菜单。

   <img width="300" alt="screenshot highlighting the branch selection" src="https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/branch-selection-dropdown.png?raw=true">

4. 在输入框中输入新分支名 `my-first-branch`。注意：必须使用这个名字，才能触发课程后续流程。

5. 点击 **Create branch: my-first-branch** 按钮来创建分支。

   <img width="300" alt="screenshot highlighting the create branch prompt" src="https://github.com/khalil1103/skills-introduction-to-github/blob/main/.github/images/create-branch-prompt.png?raw=true">
